...
final class FLChildTheme
{
    ...
    {
        wp_enqueue_style('ccpsa', FL_CHILD_THEME_URL . '/style.css?v=2024-10-07');
        wp_enqueue_style('ccpsa-boccia-custom', FL_CHILD_THEME_URL . '/style-boccia-custom.css?v=2024-10-07');
